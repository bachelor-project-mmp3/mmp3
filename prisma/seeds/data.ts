import {LivingType, RequestStatus, NotificationType } from "@prisma/client";
...
export const users = [
    {
        ...
        livingType: LivingType.PRIVATE,
        city: 'Salzburg',
        zip: 5020,
        uptown: 'Lehen',
        street: 'Lehener Hauptstraße 20',
        image: null,
    ...
    },
    {
      ...
      },
      {
        ...
        lastName: 'Mustermann',
        email: '12345@test.at',
        livingType: LivingType.DORMITORY,
        city: 'Urstein',
        uptown: 'Puch',
