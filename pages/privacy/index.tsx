...
const Privacy = () => {
    return (
        <>
            <Head>
                <title>{`Studentenfutter - Privacy`}</title>
            </Head>
            <Layout>
                <StyledDiv>
                    ...
                    <p>
                        ...
                        information when you use the website. By using the
                    ...
                    <p>
                        ...
                        of the University of Applied Sciences Salzburg is used.
                    ...
                    * optional
                    ...
                    <ul>
                        <li>
                            ...
                            functionalities of the website that are available to
                    ...
                    <p>
                        You may update your information at any time by signing
                        in to your account and visiting the account settings
                        section that allows you to manage your personal
                        information.
                    </p>
                    <p>
                        Contact us to request an overview of your personal data
                    ...
                    <p>
                        ...
                        email and/or a prominent notice on our website, prior to
